...
export default function Register() {
  ...
  return (
    <div className='h-[85vh] flex justify-center items-center'>
      {
        showOTPVerify ? <div className="h-[85vh] flex justify-center items-center bg-gray-800">
          ...
          <div className="h-full w-full flex justify-center items-center bg-gray-700/50 backdrop-blur-sm absolute top-0">
            <OTPVerification />
          </div>
      }
    </div>
