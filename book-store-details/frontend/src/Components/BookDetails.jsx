...
// export default function BookDetails({ book, editData }) {
//   return (
...
//           <button className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition-colors duration-300" onClick={() => editData(book._id)} >
//             Edit
//           </button>
//         </NavLink>
